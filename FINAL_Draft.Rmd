...
Our investigation aimed to look at the five runestone carvers in 11th century Sweden with the most runestones signed by them. We compared their styles, dating as well as their locations in order to make inferences about their defining characteristics as individual carvers.
...
Combined the ‘Arch Master’ and ‘Arch Crosses Spreadsheets’ into a single ‘merged’ data frame.
<br>

### Structure {-}

In cleaning the data, we created new columns from which we produced our graphs. Of note are the character columns ‘Signed’ and ‘Clean_styles’ which contain who solely signed the runestone and the style of it respectively. We also converted the coordinate data to WGS1984 latitude and longitude columns, treating that data as numeric.

### Limitations {-}

As not all runestones were signed, we could not confidently assume that the data collected wholly represents its carvers’ characteristics. Due to the nature of the runestones being subject to the passage of time, many have become unidentifiable.
<br>

### Assumptions {-}

In analysing the stylistic choices, we assumed that the carvers themselves were the primary factor that influenced how they engraved runestones. However, this data may be skewed by other factors such as who commissioned the carving, and the socio-religious purposes of a given runestone.
<br>

### Data Cleaning {-}

We removed entries that did not have complete coordinate data and which did not have a single signature. This narrowed our dataset to around 100 entries which was consistent with our research interest to centre mainly on the characteristics of the top carvers only.
<br>
...
```{r Wrangling and Cleaning, message=FALSE, warning=FALSE}
...
### Question 1: Who had the most signed runestones and how is their age reflected in the dating of their works? {.unnumbered}
...
As seen in Figure 1, Öpir had the most runestones signed, totalling 45; more than twice as many as the runner-up, Balle.  Based on the dating system, Öpir likely lived later than the other carvers, considering that he was the only carver with Pr5 style stones. Balle and Fot were likely the most senior given the presence of the earlier styles of Fp and RAK runestones. In general, the later Pr3-Pr5 were the most popular for the signed runestones across these carvers giving credence to the hypothesis that signing runestones may have been a later phenomenon in the scope of the 11th century
...
Through examining the proportions in which certain typological cross features (Lager, 2002 cited in Thoeming, 2016) occurred, we aimed to compare the stylistic tendencies of these carvers. As shown in figure 2, the top carvers all tended to use a mix of most crosses, except for the G type cross, which was only predominantly used by Visäte, favouring a more conservative, asymmetric style. The total absence of type G for both Balle and Fot also suggest it may have been a regional style, shown by the clustering of both carvers in figure 3. The type E style was also used proportionally less, which, based on its features, implies it was a more ornamental or ceremonial style. 

<br>

### Question 3: Where were the runestones located and what does their density suggest about the regional preferences of their carvers? {.unnumbered}
...
As shown in Figure 3, we constructed a scatterplot using the WGS1984 latitude and longitude coordinate data for each runestone. Layered on top is a density approximation to give a better visual idea of how close together each carver’s runestones were. The majority of runestones of Visate and Balle were found in relatively close proximity to one another, while the runestones of Fot, Öpir and Asmund were more spread out. Interesting to note are the outliers of Asmund located far north in comparison to his other works which shows how certain carvers moved around, creating carvings in many different places, while some chose to stay within a close proximity.

<br>

## Related Articles {.unnumbered}

Our findings are predicated on the accuracy of Gräslund (2006) for dating these carvers in Question 1 (Figure 1). We also relied on Lager (2002) depiction of the physical features of the various cross typologies to make conclusions about the carvers stylistics choices in Figure 2.
...
Eben: Figure 2 and figure density overlay, general coding


Ilana: Video shooting and editing


Michael: Report writing


Vince: Plotting and plot aesthetics, added tables and picture annotations to graphs


Kevin: Report Editing 

<br>

### General Contributions {-}
All members helped refine and discuss the general ideas around our research report via a shared google document and zoom discussions.
